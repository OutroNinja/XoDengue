                ...
                >
                    <section className="w-full">
                        ...
                        <Card className="w-full my-5">
                            <CardHeader>
                                <CardTitle>
                                    Escrito por: Léticia Silva Parreiras
                                </CardTitle>
                                <CardDescription>
                                ...
                                <Card className="flex-1">
                                    <CardContent>
                                        <div className="flex items-center space-x-4 py-5">
                                            ...
                                            <div>
                                                <p className="text-sm font-medium leading-none">Léticia Silva Parreiras</p>
                                                <p className="text-sm text-muted-foreground">Responsável por escrever essa página.</p>
                                            </div>
                                        </div>
                                    </CardContent>
                                </Card>
